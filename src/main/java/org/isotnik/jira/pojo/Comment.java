...
public class Comment {
    ...
    private String id;
    private User author;
    private GetIssueResponse.Fields.Description body;
    ...
    public GetIssueResponse.Fields.Description getBody() {
        return body;
    }

    public void setBody(GetIssueResponse.Fields.Description body) {
        this.body = body;
    }
